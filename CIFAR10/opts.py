...
def gen_synth_data_opts():
    ...
    ''' Overall settings '''
    parser.add_argument('--exp_name', type=str, default='main_ntrain_50000')
    ...
    parser.add_argument('--dre_precnn_net', type=str, default='DenseNet121',
    ...
    parser.add_argument('--dre_lr_decay_epochs', type=str, default='150_250', help='decay lr at which epoch; separate by _')
    ...
    # parser.add_argument('--subsampling_within_class', action='store_true', default=False,
    #                     help='For the unconditional DRE-F-SP+RS; Whether or not subsample within each class?')
    ...
    parser.add_argument('--eval_ref', action='store_true', default=False)
