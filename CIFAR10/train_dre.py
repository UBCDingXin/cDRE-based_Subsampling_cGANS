...
# training function
def train_dre(trainloader, dre_net, dre_precnn_net, netG, path_to_ckpt=None):
    ...
    for epoch in range(dre_resume_epoch, dre_epochs):
        ...
        print("DRE+{}+lambda{} Class {}: [epoch {}/{}] [train loss {}] [Time {}]".format(dre_net_name, dre_lambda, batch_real_labels[0], epoch+1, dre_epochs, train_loss/(batch_idx+1), timeit.default_timer()-start_time))
