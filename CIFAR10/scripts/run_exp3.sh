############################################
# EXP 3: NTRAIN=10K, BigGAN
ROOT_PATH="/home/xin/OneDrive/Working_directory/Subsample_cGANs_via_cDRE/CIFAR10_v2"
...
PreCNN="ResNet34" ##ResNet34 or DenseNet121
...
# # --samp_batch_size 1000 --samp_burnin_size 1000 --samp_nfake_per_class 500 --samp_dump_fake_data \
