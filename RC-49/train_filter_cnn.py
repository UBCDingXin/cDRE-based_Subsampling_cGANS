...
def train_filter_cnn(net, net_name, trainloader, testloader, epochs, resume_epoch=0, save_freq=[50, 100, 150], lr_base=0.1, lr_decay_factor=0.1, lr_decay_epochs=[100, 150], weight_decay=1e-4, seed = 2020, path_to_ckpt = None):
