...
# training function
def train_cdre(kernel_sigma, kappa, train_images, train_labels, test_labels, dre_net, dre_precnn_net, netG, net_y2h, PreNetFilter=None, filter_mae_cutoff_point=1e30, path_to_ckpt=None):
    '''
    ...
    for epoch in range(dre_resume_epoch, dre_epochs):
        ...
        for batch_idx in range(len(train_images)//dre_batch_size):
            ...
            #Softplus loss: vicinal trick for real images only
