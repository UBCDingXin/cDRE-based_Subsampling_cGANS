...
class ResNet_extract(nn.Module):
    def __init__(self, block, num_blocks, num_classes=5, nc=NC, img_height=IMG_SIZE, img_width=IMG_SIZE):
        ...
        self.main = nn.Sequential(
            ...
            nn.BatchNorm2d(64),
            nn.ReLU(),
            self._make_layer(block, 64, num_blocks[0], stride=2),  # h=h
